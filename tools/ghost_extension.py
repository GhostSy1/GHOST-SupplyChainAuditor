...
TOOL = "GHOST-SupplyChainAuditor"
VERSION = "3.0-PRO"
PROFILE = "Dependency manifest and supply-chain risk auditor"
RULES = [('DEP-PIN', 'package|dependency|requires|version|lock'), ('DEP-HASH', 'integrity|sha256|hash|digest'), ('DEP-SCRIPT', 'preinstall|postinstall|install script|setup\\.py')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-SupplyChainAuditor v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
